...
CREATE TABLE `User` (
    ...
    `role` ENUM('KARYAWAN', 'SUPER ADMIN') NOT NULL DEFAULT 'KARYAWAN',
...
CREATE TABLE `Produk` (
    ...
    `kategori` ENUM('OBAT BEBAS', 'OBAT KERAS', 'KONSI', 'ALKES') NOT NULL,
...
CREATE TABLE `ProdukKeluar` (
    ...
    `status` ENUM('TERJUAL', 'KADALUARSA', 'RUSAK', 'TIDAK SESUAI') NOT NULL,
